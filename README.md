# PORTFOLIO - INTELLIGENCE ARTIFICIELLE
...
## Prédiction de loyer d'appartements des arrondissements de Paris
...
## Étude du K-NN sur le jeu de données MNIST
...
## Ré-implémentation de GridSearchCV de la librairie scikit-learn pour la prédiction de la qualité du vin
...
## Kaggle Competition : Leaf Classification - Classement automatique des feuilles d’arbres
...
## SVM à noyau pour la prédiction la qualité de vin
...
## Regression Ridge à noyau pour la prédiction la qualité de vin
...
## Human Activity Recognition Using Smartphones Data - Mesure de la puissance des forêts aléatoires
...
You can use the [editor on GitHub](https://github.com/JMT-AI/Portfolio/edit/master/README.md) to maintain and preview the content for your website in Markdown files.
...
Your Pages site will use the layout and styles from the Jekyll theme you have selected in your [repository settings](https://github.com/JMT-AI/Portfolio/settings). The name of this theme is saved in the Jekyll `_config.yml` configuration file.
